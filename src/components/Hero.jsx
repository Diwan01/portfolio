...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-6">
      ...
      {/* Light mode only: soft white vignette hides grid at edges */}
      <div
        className="absolute inset-0 pointer-events-none dark:opacity-0 transition-opacity duration-500"
        style={{
          background:
            'radial-gradient(ellipse 75% 65% at 50% 50%, transparent 20%, rgba(250,250,250,0.97) 88%)',
        }}
      />

      {/* Dark mode only: deep zinc vignette — no white, no fog */}
      <div
        className="absolute inset-0 pointer-events-none opacity-0 dark:opacity-100 transition-opacity duration-500"
        style={{
          background:
            'radial-gradient(ellipse 75% 65% at 50% 50%, transparent 20%, rgb(9,9,11) 88%)',
        }}
      />

      {/* Glow — barely visible in light, intentional in dark */}
      <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
        <div className="w-[900px] h-[700px] rounded-full bg-indigo-500/[0.05] dark:bg-indigo-500/[0.13] blur-3xl" />
      </div>
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <span className="w-px h-[14px] bg-zinc-300 dark:bg-zinc-600 rounded-full" />
        ...
        <motion.p
          ...
          className="text-base sm:text-lg font-normal leading-relaxed mb-10
            text-zinc-500 dark:text-zinc-400
            max-w-[440px] mx-auto"
        >
          Building scalable, practical, and user-focused technology solutions.
        </motion.p>
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="w-full sm:w-auto px-7 py-3 rounded-xl text-sm font-semibold text-white
              bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700
              shadow-lg shadow-indigo-600/25 dark:shadow-indigo-600/20
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.03, y: -1, transition: { duration: 0.15, ease: 'easeOut' } }}
            whileTap={{ scale: 0.97 }}
            className="w-full sm:w-auto px-7 py-3 rounded-xl text-sm font-semibold
              text-zinc-700 dark:text-zinc-200
              border border-zinc-300 dark:border-zinc-600
              bg-white/80 dark:bg-zinc-800/40
              hover:bg-zinc-50 dark:hover:bg-zinc-800/70
              hover:border-zinc-400 dark:hover:border-zinc-500
              transition-all duration-150
              focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 dark:focus-visible:ring-zinc-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-zinc-950"
          >
            Contact Me
          </motion.button>
        </motion.div>
